...
export default function CompetitionDetailView({
  ...
  const teamText = tournament.teams ?? "0";
  const maxQuota = parseInt(teamText.replace(/\D/g, "")) || 100;
      ...
      <main className="main-container container-fluid d-flex pt-0 px-0 position-relative">
        ...
        <article className="main-content w-100">
          ...
          >
            <div
              className="gps-meta"
              style={{ padding: "0 0 24px", maxWidth: "900px" }}
            >
              <div className="mb-4">
                <Breadcrumbs />
              </div>
          ...
          <div className="container-fluid px-lg-15 px-md-10 px-6 mt-10 pb-120">
            <section className="tournament-details">
              <div className="row g-10">
                  ...
                  >
                    ...
                    <div className="row g-4 mb-8">
                      <div className="col-md-6">
                        <div
                          className="info-box d-flex align-items-start gap-3 p-4 rounded-4 h-100"
                          style={{
                        ...
                        >
                          <div
                            className="icon-circle bg-warning text-white mt-1 d-flex align-items-center justify-content-center"
                            style={{
                              width: "40px",
                              height: "40px",
                              borderRadius: "50%",
                          ...
                          <div>
                            ...
                            <p className="tcn-6 fs-sm mb-0">
                              Menguji kemampuan akademik dan strategi gameplay.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        ...
                        >
                          ...
                          <div>
                            <h5 className="tcn-1 fw-bold fs-md mb-2">
                              Tingkat
                            </h5>
                            <p className="tcn-6 fs-sm mb-0">
                              Kompetisi kompetitif skala nasional.
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  >
                    ...
                    <div className="rules-grid d-flex flex-column gap-3">
                      {tournament.rules?.map((rule, index) => (
                        <div
                          key={index}
                          className="rule-item d-flex align-items-start gap-3 p-4 rounded-3"
                          style={{
                ...
                <div
                  className="col-lg-4 animate-fade-in-up"
                ...
                >
                  ...
                  >
                    <div
                      className="info-card p-6 rounded-4 border"
                      style={{
                    ...
                    >
                      ...
                      <h4 className="tcn-6 fs-sm text-uppercase mb-2">
                        Total Hadiah
                      </h4>
                      <h2 className="text-warning fw-bold display-six mb-6">
                      ...
                      <div className="d-flex flex-column gap-4 mb-8">
                        <div className="d-flex align-items-center gap-3">
                          ...
                          <div>
                            <span className="d-block tcn-6 fs-xs text-uppercase">
                              Pelaksanaan
                            </span>
                            <span className="tcn-1 fw-bold">
                              {tournament.date}
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="d-flex align-items-center gap-3">
                          ...
                          <div>
                            ...
                            <span className="tcn-1 fw-bold">
                              {currentRegistered} / {maxQuota} Tim
                            </span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="progress-area mb-8">
                        <div className="d-flex justify-content-between mb-2">
                          <span className="tcn-6 fs-xs text-uppercase">
                            Kapasitas
                          </span>
                          <span className="tcn-1 fw-bold fs-xs">
                            {progressPercent.toFixed(0)}%
                          </span>
                        </div>
                        <div
                          className="progress rounded-pill bg-secondary bg-opacity-25"
                          style={{ height: "8px" }}
                        >
                          <div
                      ...
                      {isFull ? (
                        <button
                          className="btn btn-secondary w-100 py-3 rounded-3 fw-bold"
                          disabled
                        >
                          Kuota Penuh
                        </button>
                        ...
                        <Link
                          href={`/competitions/${tournament.slug}/register`}
                          className="gps-btn-primary w-100 py-3 rounded-3 fw-bold justify-content-center text-center text-decoration-none text-white d-block"
                          style={{
                            background: "#ff8c00",
              ...
              {/* TIMELINE & PRIZES */}
              <div
                className="row mt-12 g-10 animate-fade-in-up"
              ...
              >
                ...
                <div className="col-lg-12">
                  ...
                  <div
                    className="timeline-container p-6 rounded-4 d-flex flex-column flex-md-row justify-content-between position-relative gap-6 gap-md-0"
                    style={{
                      background: "rgba(20,20,20,0.6)",
                      border: "1px solid rgba(255,255,255,0.05)",
                    }}
                  >
                    <div
                      className="timeline-line d-none d-md-block position-absolute top-50 start-0 w-100"
                      style={{
                        height: "2px",
                        background: "rgba(255,255,255,0.1)",
                    ...
                    <div
                      className="timeline-step text-md-center position-relative z-1 d-flex flex-md-column align-items-center gap-4 gap-md-0"
                      style={{ flex: 1 }}
                    >
                      <div
                        className="timeline-dot mb-md-3 bg-warning d-flex align-items-center justify-content-center border border-3 border-dark"
                        style={{
                          width: "32px",
                          height: "32px",
                          borderRadius: "50%",
                      ...
                      <div>
                        <h5 className="tcn-1 fw-bold fs-md mb-1">
                          Pendaftaran
                        </h5>
                    ...
                    >
                      <div
                        className="timeline-dot mb-md-3 bg-secondary d-flex align-items-center justify-content-center border border-3 border-dark"
                        style={{
                          width: "32px",
                          height: "32px",
                          borderRadius: "50%",
              ...
              <div
                className="row mt-12 g-6 animate-fade-in-up"
              ...
              >
                ...
                <div className="col-md-4">
                  ...
                  >
                    ...
                    <h4 className="fw-bold text-warning mb-2 text-uppercase">
                      {tournament.prizes?.[0]?.place || "JUARA 1"}
                    </h4>
                    <h3 className="fw-extrabold text-white mb-3">
                      {tournament.prizes?.[0]?.amount || "Rp 7.500.000"}
                    </h3>
                    <p className="tcn-6 fs-sm mb-0">
                      {tournament.prizes?.[0]?.reward || "Trofi & Sertifikat"}
                    </p>
                  </div>
                </div>
                {/* Juara 2 */}
                <div className="col-md-4">
                  ...
                  >
                    <i
                      className="ti ti-medal fs-display-four text-secondary mb-4 d-block"
                      style={{ color: "#c0c0c0" }}
                    ></i>
                    <h4
                      ...
                      style={{ color: "#c0c0c0" }}
                    >
                      {tournament.prizes?.[1]?.place || "JUARA 2"}
                    </h4>
                    <h3 className="fw-extrabold text-white mb-3">
                      {tournament.prizes?.[1]?.amount || "Rp 5.000.000"}
                    </h3>
                    <p className="tcn-6 fs-sm mb-0">
                      {tournament.prizes?.[1]?.reward || "Medali & Sertifikat"}
                    </p>
                  </div>
                </div>
                {/* Juara 3 */}
                <div className="col-md-4">
                  ...
                  >
                    <i
                      className="ti ti-medal fs-display-four mb-4 d-block"
                      style={{ color: "#cd7f32" }}
                    ></i>
                    <h4
                      className="fw-bold mb-2 text-uppercase"
                      style={{ color: "#cd7f32" }}
                    >
                      {tournament.prizes?.[2]?.place || "JUARA 3"}
                    </h4>
                    <h3 className="fw-extrabold text-white mb-3">
                      {tournament.prizes?.[2]?.amount || "Rp 2.500.000"}
                    </h3>
                    <p className="tcn-6 fs-sm mb-0">
                      {tournament.prizes?.[2]?.reward || "Medali & Sertifikat"}
                    </p>
                  </div>
                </div>
              </div>
