  ...
  const gamingAccounts = [
    {
      id: 1,
      name: "Axie Origin",
      image: "/assets/img/gl-1.png",
      connected: false,
    },
    {
      id: 2,
      name: "Rocket League",
      image: "/assets/img/gl-2.png",
      connected: false,
    },
    {
      id: 3,
      name: "Valorant",
      image: "/assets/img/gl-3.png",
      connected: false,
    },
    {
      id: 4,
      name: "Battlegrounds",
      image: "/assets/img/gl-4.png",
      connected: false,
    },
    {
      id: 5,
      name: "Hollow Knight",
      image: "/assets/img/gl-5.png",
      connected: false,
    },
    {
      id: 6,
      name: "Rocket League",
      image: "/assets/img/gl-6.png",
      connected: false,
    },
    {
      id: 7,
      name: "Apex Legends",
      image: "/assets/img/gl-7.png",
      connected: false,
    },
    {
      id: 8,
      name: "Doom Eterna",
      image: "/assets/img/gl-8.png",
      connected: false,
    },
    {
      id: 9,
      name: "Stardew Valley",
      image: "/assets/img/gl-9.png",
      connected: false,
    },
    {
      id: 10,
      name: "Genshin Impact",
      image: "/assets/img/gl-10.png",
      connected: false,
    },
  ];
                  ...
                  <div className="user-earning-area py-8 px-4 bgn-4 rounded">
                    <div className="d-between mb-8">
                      ...
                      <Button
                        asChild
                        size="sm"
                        className="bg-primary text-primary-foreground hover:bg-primary/90 rounded-full font-bold px-4"
                      >
                        <a href="#">Claim</a>
                      </Button>
                    </div>
              ...
              <div className="row g-6">
                {gamingAccounts.map((account) => (
                  <div key={account.id} className="col-xxl-3 col-lg-4 col-md-6">
                    <div
                      className="gaming-account-card p-sm-8 p-3 bgn-4 rounded card-tilt"
                      data-tilt
                    >
                      <div className="d-between mb-10">
                        ...
                        <span className="py-2 px-3 bgn-3 rounded-pill tcn-1">
                          {account.connected ? "Connected" : "Not Connected"}
                        </span>
                      </div>
                      <span className="tcn-1 fs-four title mb-3 title-anim">
                        {account.name}
                      </span>
                      <a
                        href="#"
                        className="tcn-1 d-block mb-8 text-decoration-underline"
                      >
                      ...
                      <div className="text-center">
                        <Button
                          asChild
                          className="rounded-full px-8 py-4 font-bold bg-primary hover:bg-primary/90 text-primary-foreground text-base shadow-btn w-full hover-lift"
                        >
                          <a href="#">Connect</a>
                        </Button>
                      </div>
